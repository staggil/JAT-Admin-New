<%@ Page Title="Private Entry" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="privateEntry.aspx.cs" Inherits="JAT.Private.privateEntry" %>
                    ...
                    <form>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="form-group col-md-5">
                                        <%--<input runat="server" id="Box1" type="checkbox" name="vehicle1" value="Bike">--%>
                                    ...
                                    <div class="form-group col-md-6">
                                        <%--<input type="text" onkeypress="numberOnly(event)" maxlength="10" id="Box2" runat="server" placeholder="" style="width: 220px">--%>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="form-group col-md-5">
                                        <%--<asp:CheckBox ID="Box4" runat="server" />--%>
                                        <label style="color: red;">*</label>
                ...
                <div class="box" style="background-color: lightgray">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="form-group col-md-5">
                                    <%--<asp:CheckBox ID="Box10" runat="server" />--%>
                                    <label style="color: red; visibility: hidden;">*</label>
                                    <label lang="eng"><%=Resources.Resources.company_name %></label>
                                    <%--@*<label lang="jpn">会社名</label>*@--%>
                                    <span style="float: right;">:</span>
                                </div>
                                <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="form-group col-md-5">
                                    <%--<asp:CheckBox ID="Box12" runat="server" />--%>
                                    <label style="color: red; visibility: hidden;">*</label>
                                    <label lang="eng"><%=Resources.Resources.address %></label>
                                    <%--@*<label lang="jpn">住所</label>*@--%>
                                    <span style="float: right;">:</span>
                                </div>
                                <div class="form-group col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <%--<asp:CheckBox ID="Box14" runat="server" />--%>
                                    <label style="color: red; visibility: hidden;">*</label>
                                ...
                                <div class="form-group col-md-4">
                                    <%--                                <input type="tel" id="Box15" runat="server" style="width: 90%;"
                                       pattern="[0-9]{1}-[0-9]{4}-[0-9]{4}" placeholder="x-xxxx-xxxx"> --%>
                                    <%--<input id="Box15" runat="server" style="width: 90%;" placeholder="x-xxxx-xxxx">--%>
                                    <%--<input id="Box15" runat="server" style="width: 90%;" pattern="[0-9]{1}-[0-9]{4}-[0-9]{4}" placeholder="x-xxxx-xxxx">--%>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <%--<input type="tel" id="Box17" runat="server" style="width: 90%;"
                                       pattern="[0-9]{1}-[0-9]{4}-[0-9]{4}" placeholder="x-xxxx-xxxx">--%>
                                    <%--<input type="tel" id="Box17" runat="server" style="width: 90%;"
                                       pattern="[0-9]{1}-[0-9]{4}-[0-9]{4}" placeholder="x-xxxx-xxxx">--%>
                ...
                <div class="box" style="background-color: lightgray">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="form-group col-md-5">
                                    <%--<asp:CheckBox ID="Box19" runat="server" />--%>
                                    <label style="color: red; visibility: hidden;">*</label>
                                    <label lang="eng"><%=Resources.Resources.address %></label>
                                    <%--@*<label lang="jpn">住所</label>*@--%>
                                    <span style="float: right;">:</span>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <%--<asp:CheckBox ID="Box21" runat="server" />--%>
                                    <label style="color: red; visibility: hidden;">*</label>
                                    <label lang="eng">
                                ...
                                <div class="form-group col-md-4">
                                    <%--                                <input type="tel" id="Box22" runat="server" style="width: 90%;"
                                       pattern="[0-9]{1}-[0-9]{4}-[0-9]{4}" placeholder="x-xxxx-xxxx">--%>
                                    <%--<input id="Box22" runat="server" style="width: 90%;" pattern="[0-9]{1}-[0-9]{4}-[0-9]{4}" placeholder="x-xxxx-xxxx">--%>
                                    <input id="Box22" runat="server" style="width: 90%;" placeholder="x-xxxx-xxxx" maxlength="50" autocomplete="off" >
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <%--<asp:CheckBox ID="Box23" runat="server" />--%>
                                    <label style="color: red; visibility: hidden;">*</label>
                                ...
                                <div class="form-group col-md-4">
                                    <%--<input type="tel" id="Box24" runat="server" style="width: 90%;"  pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="xxx-xxx-xxxx">--%>
                                    <%--<input type="tel" id="Tel1" runat="server" style="width: 90%;" placeholder="(0XX)XXX-XXXX" pattern="[(]{0,}[+]{0,}[0-9]{1,}[)]{0,}[-]{0,}[0-9]{0,}[-]{0,}[0-9]{0,}[-]{0,}[0-9]{0,}[-]{0,}[0-9]{0,}|Stop\s{0,}[0-9]{1,}[/]{0,}[\/]{0,}[0-9]{0,}[0-9]{0,}\/{0-9]{0,}">--%>
                                    ...
                                    <%--<asp:RegularExpressionValidator
                                        ...
                                        ControlToValidate="Box24"
                                        ErrorMessage="Incorrect phone number format. [(0XX)XXX-XXXX]"
                                        ValidationExpression="^\([0]?[689]?[0-9]\)?[ ]?(\([0-9]\d{2}\)|[0-9]\d{2})[- .]?\d{4}$">
                                    </asp:RegularExpressionValidator>--%>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <div class="form-check" style="float: left; margin-right: 5px; font-size: 14px;">
                                        ...
                                        <%--@*<label style="font-weight:100;" lang="jpn"> 理事</label><br>*@--%>
                                        <asp:CheckBox ID="cbValue5" runat="server" />
                                        <asp:Label ID="sub_tmp2" runat="server"></asp:Label><br>
                                        <%--@*<label style="font-weight:100;" lang="jpn"> すくすく会</label><br>*@--%>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    <asp:DropDownList ID="Box34" runat="server">
                    ...
                    <div class="form-group" style="text-align: center;">
                        <div class="text-center">
                            ...
                            <%--<button lang="eng" id="cancelBtn" class="btn btn-primary" style="text-align: center;" onclick="cancelInput()">Cancel</button>--%>
                            <%--<button lang="jpn" id="cancelBtnJP" class="btn btn-primary" style="text-align: center;" onclick="cancelInput()">キャンセル</button>--%>
                        </div>
                    </div>
                </div>
                </form>
