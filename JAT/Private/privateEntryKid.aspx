<%@ Page Title="Private EntryKid" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="privateEntryKid.aspx.cs" Inherits="JAT.Private.privateEntryKid" %>
            ...
            <div class="box">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
                    ...
                    <Columns>
                        ...
                        <%--                        <asp:TemplateField>
                         <ItemTemplate>                    
                        <asp:HiddenField ID="HiddenField1" runat="server" Value='<%# Eval("childid") %>' />
                        </ItemTemplate>
                        </asp:TemplateField>--%>

                        <asp:BoundField HeaderText="" DataField="childid" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol">
                            <HeaderStyle BackColor="#24227A" ForeColor="White" HorizontalAlign="Center" />
                            <ItemStyle Width="80pt" />
                        </asp:BoundField>

                        <asp:BoundField HeaderText="" DataField="prefixKid" HeaderStyle-CssClass="text-center">
                            <HeaderStyle BackColor="#24227A" ForeColor="White" HorizontalAlign="Center" />
                            <ItemStyle Width="80pt" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="<%$Resources:Resources,name %>" DataField="nameKidJ" HeaderStyle-CssClass="text-center">
                            <HeaderStyle BackColor="#24227A" ForeColor="White" HorizontalAlign="Center" />
                            <ItemStyle />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="<%$Resources:Resources,name_eng %>" DataField="nameKidE" HeaderStyle-CssClass="text-center">
