...
using JAT.Core;
using JAT.PrivateReport.Services;
...
namespace JAT.PrivateReport
{
    public partial class reportPrivateDetail : System.Web.UI.Page
    {
        ...
        */
        ...
        private void SetReport(ReportViewer reportViewer, string reportPath, DataTable dt, Dictionary<string, string> parameters = null)
        {
            ...
            if (parameters != null)
            {
                ...
                {
                    reportViewer.LocalReport.SetParameters(new ReportParameter(param.Key, param.Value));
                }
            }
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            using (conn = new SqlConnection(connStr))
            {
                ...
                {
                    ReportPrivateDetailService service = new ReportPrivateDetailService();
                    //conn.Open();
                    ...
                    SetReport(ReportViewer1, "~/PrivateReport/ReportPage/printPrivateList.rdlc", dt);
                ...
                else if (displayCho1 == "Cancel Member")
                {
                   ...
                   // conn.Open();
                    ...
                    SetReport(ReportViewer1, "~/PrivateReport/ReportPage/printPrivateCancel.rdlc", dt);
                ...
                else if (displayCho1 == "Honor Member")
                {
                   ...
                   // conn.Open();
                    ...
                    SetReport(ReportViewer1, "~/PrivateReport/ReportPage/printPrivateHorner.rdlc", dt);
                ...
                else if (displayCho1 == "Family Member")
                {
                 ...
                 //   conn.Open();
                    ...
                    SetReport(ReportViewer1, "~/PrivateReport/ReportPage/printPrivateFamily.rdlc", dt2);
                ...
                else if (displayCho1 == "Change Address")
                {
                  ...
                  //  conn.Open();
                    ...
                    SetReport(ReportViewer1, "~/PrivateReport/ReportPage/printPrivateListChangeAddress.rdlc", dt);
                ...
                else if (displayCho1 == "Election Label")
                {
                  ...
                  //  conn.Open();
                    ...
                    DataTable dt2 = new DataTable();
                    adapter2.Fill(dt2);
                    SetReport(ReportViewer1, "~/PrivateReport/ReportPage/printPrivateElection.rdlc", dt2);
                ...
                else if (displayCho1 == "List Receiver")
                {
                   ...
                   // conn.Open();
                    ...
                    adapter.SelectCommand.CommandTimeout = 600;
                    adapter.Fill(dt);
                    SetReport(ReportViewer1, "~/PrivateReport/ReportPage/printPrivateListReceiver.rdlc", dt);
                ...
                else if (displayCho1 == "KrungThep Magazine")
                {
                   ...
                   // conn.Open();
                    ...
                    adapter2.Fill(dt2);
                    SetReport(ReportViewer1, "~/PrivateReport/ReportPage/printPrivateMag.rdlc", dt2);
                ...
                else if (displayCho1 == "Withdrawal=>Re-enrollment")
                {
                  ...
                  //  conn.Open();
                    ...
                    SetReport(ReportViewer1, "~/PrivateReport/ReportPage/printPrivateReenrollment.rdlc", dt);
