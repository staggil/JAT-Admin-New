<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="regFamilyCheck.aspx.cs" Inherits="JAT.Admin.RegisterMember.regFamilyCheck" %>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <%--<asp:RequiredFieldValidator ErrorMessage="Required" ControlToValidate="Box7" InitialValue="99" runat="server" ForeColor="Red" />--%>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
