<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="JAT.Maintenance.ChangePassword" %>
...
<%--                <asp:Label ID="staffName" runat="server" Text="Change Password"></asp:Label>
            </div>--%>
        </div>
        <div class="row">
            <div class="form-group col-sm-3">
